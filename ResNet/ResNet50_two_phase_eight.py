...
class ResNet50(nn.Module):
    def __init__(self,num_classes=10,num_channels = 64,include_top=True):
        ...
        self.padupper = nn.ZeroPad2d(padding=(3,3,3,0))
        self.padupper2 = nn.ZeroPad2d(padding=(1,1,1,0))
        self.paddown = nn.ZeroPad2d(padding=(3,3,0,3))
        self.paddown2 = nn.ZeroPad2d(padding=(1,1,0,1))
        self.pad2 = nn.ZeroPad2d(padding=(1,1,0,0))
        self.pad = nn.ZeroPad2d(padding=(3,3,0,0))
        if self.include_top:
    ...
    def forward(self,x):
        ...
        bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x4 =checkpoint(self.block1_medium,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x4)
        bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x5 =checkpoint(self.block1_medium,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x5)
        bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x6 =checkpoint(self.block1_medium,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x6)
        bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x7 =checkpoint(self.block1_medium,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x7)
        

        # print(x1.size())
        x8 = checkpoint(self.block1_tail,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x8)
