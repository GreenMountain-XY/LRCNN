...
class VGG16(nn.Module):
    ...
    def forward(self, x):
        ...
        x = checkpoint(self.first_checkpoint,x)
        x = checkpoint(self.five_checkpoint,x)
        x = checkpoint(self.second_checkpoint,x)
        x = checkpoint(self.third_checkpoint,x)
        x = checkpoint(self.forth_checkpoint,x)
        return x
