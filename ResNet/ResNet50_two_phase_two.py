...
class ResNet50(nn.Module):
    ...
    def block2_forward(self,x):
        ...
        x2 = checkpoint(self.block2_tail,identity1,identity2,identity3,identity4,bound1, bound2, bound3, bound4,x2)
    ...
    def forward(self,x):
        ...
        # print(x1.size())
        x2 = checkpoint(self.block1_tail,bound_static,identity1,identity2,identity3,bound1, bound2, bound3,x2)
        # print(x1.size())
        # print(x2.size())
        # print(x3.size())
        # print(x4.size())
