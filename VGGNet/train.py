...
# from no_checkpoint.VGG16_8 import VGG16
# from no_checkpoint.VGG16_8_deep_optimizer import VGG16
# from VGG16_checkpoint import VGG16
# from high_resolution.VGG16_overlap import VGG16
# from high_resolution.VGG16_two_phase import VGG16
# from high_resolution.VGG16_overlap_no_checkpoint import VGG16
# from high_resolution.VGG16_two_phase_no_checkpoint import VGG16
# from VGG16_twophase_six import VGG16
# from VGG16 import VGG16
# from VGG16_twophase_two import VGG16
# from VGG16_overlap_eight_2 import VGG16
# from VGG16_overlap_three import VGG16
# from VGG16_overlap_two_2 import VGG16
# from VGG16_overlap_four_2 import VGG16
# from VGG16_overlap_six_2 import VGG16
# from VGG16_overlap_ten_2 import VGG16
# from VGG16_overlap_ten_2 import VGG16
# from no_checkpoint.VGG16_overlap_four import VGG16
# from no_checkpoint.VGG16_8 import VGG16
# from VGG16_6 import VGG16
# from VGG16_8 import VGG16
# from VGG16_10 import VGG16
# from VGG16_four import VGG16
from load_ImageNet import load_ImageNet


train_loader, val_loader, train_dataset, val_dataset = load_ImageNet('dataset',batch_size=8,size=920)
...
for epoch in range(1):  # loop over the dataset multiple times 训练5轮
    ...
    # test_accuracys.append(test_correct/test_num)
        print(f"整个训练过程显存最大占用:{torch.cuda.max_memory_allocated()/(1024 * 1024 * 1024):.3f}GB")
t1 = time.time()
print(t1-t0)
print(f"整个训练过程显存最大占用:{torch.cuda.max_memory_allocated()/(1024 * 1024 * 1024):.3f}GB")
del(net)
...
# import pandas as pd
# data = pd.DataFrame({'train_loss':train_losses, 'train_accuracy':train_accuracys, 'test_accuracy':test_accuracys})
# data.to_csv("压力测试.csv",index=None)
# # save_path = './Lenet.pth'
