...
class VGG16(nn.Module):
    ...
    def forward(self, x):
        ...
        x4 = checkpoint(self.medium1,x4)
        x5 = checkpoint(self.medium1,x5)
        x6 = checkpoint(self.medium1,x6)
        x7 = checkpoint(self.medium1,x7)
        x8 = checkpoint(self.medium1,x8)
        x9 = checkpoint(self.medium1,x9)
        x10 = checkpoint(self.tail1,x10)
        # print(x1.size())
        # print(x2.size())
