...
# from ResNet50_two_phase import ResNet50
...
# import pandas as pd
# data = pd.DataFrame({'train_loss':train_losses, 'train_accuracy':train_accuracys, 'test_accuracy':test_accuracys,'test_loss':test_losses})
# data.to_csv("normal_resnet_lr_0.00001.csv",index=None)
# # save_path = './Lenet.pth'
